from acquisition import functions, methods
...
def recover_args(laaos_store) -> namedtuple:
    ...
    # Recover enums
    args["type"] = parse_enum_str(args["type"], functions.AcquisitionFunction)

    if "acquisition_method" in args:
        args["acquisition_method"] = parse_enum_str(args["acquisition_method"], methods.AcquisitionMethod)
    else:
        args["acquisition_method"] = methods.AcquisitionMethod.independent
